    ...
    <section class="left">
      ...
      <div class="order">
        ...
        <div class="order_note">
          <p>訂單備註</p>
          <textarea id="" name="" cols="30" rows="10" placeholder="若有其他備註事項，請在此填寫，謝謝您！"></textarea>
        </div>
      </div>
    ...
    .address_info {
      ...
      .sec {
        ...
        select {
          ...
          -moz-appearance: none;
          background: url('../imgs/icon/icon_option-w.svg') no-repeat 95% 50%;
          border-color: $ramos-gin-fizz;
